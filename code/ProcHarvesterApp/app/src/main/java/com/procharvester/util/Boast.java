...
public class Boast
{
    static public void makeBoastOnUIThread(final Activity ac, final String message) {
        ac.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Boast.makeText(ac, message).show();
            }
        });
    }

    static public void makeBoastInMainHandler(final Context cx, final String message) {
        Handler handler = new Handler(Looper.getMainLooper());
        handler.post(new Runnable() {
            @Override
            public void run() {
                Boast.makeText(cx.getApplicationContext(),
                        message,
    ...
    public static Boast makeText(Context context, CharSequence text,
                                 int duration)
    {
        return new Boast(Toast.makeText(context.getApplicationContext(), text, duration));
    }
    ...
    public static Boast makeText(Context context, int resId, int duration)
            throws Resources.NotFoundException
    {
        return new Boast(Toast.makeText(context.getApplicationContext(), resId, duration));
    }
    ...
    public static Boast makeText(Context context, CharSequence text)
    {
        return new Boast(Toast.makeText(context.getApplicationContext(), text, Toast.LENGTH_SHORT));
    }
    ...
    public static Boast makeText(Context context, int resId)
            throws Resources.NotFoundException
    {
        return new Boast(Toast.makeText(context.getApplicationContext(), resId, Toast.LENGTH_SHORT));
    }
